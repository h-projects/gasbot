exports.run = (client, message, args) => {
  if (args.join(" ")) return;
   let infoEmbed = new client.disc.MessageEmbed()
    ...
    .addField("Code", `The bot is written in Discord.JS and hosted on Azure, if you see any buqs, please tell us in the [Support Server](${client.config.serverInvite})!`, false)
