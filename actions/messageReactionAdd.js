module.exports = async (client, reaction, user) => {
  const fs = require("fs-extra")
    ...
    if (reaction.emoji.name == '🇬') {
        ...
        // Find loqs channel
        let loqChannel = reaction.message.guild.channels.cache.get(client.loqs[reaction.message.guild.id]); 
        loqChannel ??= reaction.message.guild.channels.cache.find(channel => channel.name === "loqs");
